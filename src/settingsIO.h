...
class SettingsIO {
    public:
        ...
        std::shared_ptr<Protocol> readSettings(QString filename, std::shared_ptr<Protocol> proto = NULL);
        std::shared_ptr<Protocol> readSettingsStr(QString text, std::shared_ptr<Protocol> proto = NULL);
...
private:
        std::shared_ptr<Protocol> readProtoType(std::shared_ptr<Protocol> proto, QXmlStreamReader& xml);
        std::shared_ptr<Protocol> read(std::shared_ptr<Protocol> proto, QXmlStreamReader& xml);
