...
//####### RyR channel fractions
    ...
    opts = WT;
    conflicts = {{S571E, S571A},{S2814D,S2814A}};
...
void GpbAtrialOnal17::externalStim(double stimval) {
    iTot = iTot + stimval;
}
...
void GpbAtrialOnal17::makemap()
{
  ...
  __vars["CaMKII"]=&caMkii;
  __vars["fBlock"]=&fBlock;
  __vars["fBound"]=&fBound;
  __vars["fI"]=&fI;
  __vars["fOx"]=&fOx;
  __vars["fOxP"]=&fOxP;
  __vars["fPhos"]=&fPhos;
  __vars["fiNalP"]=&fiNalP;
  __vars["RyRP"]=&RyRP;
  __vars["RyRratio"]=&RyRratio;
  __vars["Ryro"]=&Ryro;
  __vars["Ryri"]=&Ryri;
  __vars["Ryrr"]=&Ryrr;
