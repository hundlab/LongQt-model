...
CurrentClamp* CurrentClamp::clone() { return new CurrentClamp(*this); };
...
PvarsCell& CurrentClamp::pvars() { return *this->__pvars; }

MeasureManager& CurrentClamp::measureMgr() { return *this->__measureMgr; }
...
void CurrentClamp::mkmap() {
  GetSetRef toInsert;
  __pars["stimdur"] = toInsert.Initialize(
      "double", [this]() { return std::to_string(stimdur); },
      [this](const string& value) { stimdur = std::stod(value); });
  __pars["stimt"] = toInsert.Initialize(
      "double", [this]() { return std::to_string(stimt); },
      [this](const string& value) { stimt = std::stod(value); });
  __pars["stimval"] = toInsert.Initialize(
      "double", [this]() { return std::to_string(stimval); },
      [this](const string& value) { stimval = std::stod(value); });
  __pars["bcl"] = toInsert.Initialize(
      "double", [this]() { return std::to_string(bcl); },
      [this](const string& value) { bcl = std::stod(value); });
  __pars["numstims"] = toInsert.Initialize(
      "int", [this]() { return std::to_string(numstims); },
      [this](const string& value) { numstims = std::stoi(value); });
  __pars["paceflag"] = toInsert.Initialize(
...
const char* CurrentClamp::type() const { return name; }
